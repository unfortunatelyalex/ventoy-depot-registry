...
The registry currently contains 112 curated providers covering mainstream Linux and BSD
...
Debian, Fedora, Calculate Linux, openEuler, Trisquel, Arch Linux, Linux Mint, FreeBSD, NetBSD, GParted Live,
